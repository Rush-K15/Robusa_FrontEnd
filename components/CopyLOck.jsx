...
const LockSys = ({ route }) => {
  ...
  return (
   ...
   <View style={styles.overlay} />
      ...
      <Text style={styles.validityText}>{pin ? `VALIDITY : 3 minutes` : ''}</Text>       
...
const styles = StyleSheet.create({
  ...
  pinText: {
    fontSize: 30,
    fontWeight: 'bold',
    marginTop: 30, // Add some spacing between the button and the PIN text
    color: '#39FF14', // Match the color with the theme
  },
